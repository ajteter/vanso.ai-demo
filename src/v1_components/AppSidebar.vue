  ...
  <aside class="bg-vanso-card border-r border-white/10 flex flex-col h-full items-start justify-between overflow-visible p-[17px] shrink-0 w-65">
    ...
    <div class="w-full">
      <div class="flex flex-col gap-10 items-center pt-[24px] w-full">
        ...
        <nav class="flex flex-col gap-2 items-center w-full">
          <!-- Dashboard Link -->
          <button
            class="flex gap-3 items-center py-[10px] rounded-lg w-full transition-colors duration-200 cursor-pointer"
            :class="currentPage === 'Dashboard' 
              ? 'bg-[rgba(255,255,255,0.1)] border-l-2 border-vanso-magenta pl-[14px] pr-[12px]' 
              : 'px-3 hover:bg-[rgba(255,255,255,0.05)]'"
    ...
    <div class="w-full relative" ref="dropdownRef">
      ...
      <Transition name="dropdown">
        ...
        >
          <button
            class="flex gap-2.5 items-center w-full px-4 py-3 cursor-pointer transition-colors duration-150 hover:bg-white/5"
            @click="openProfile"
          >
            <!-- User icon -->
      ...
      <div class="border-t border-[rgba(255,255,255,0.1)] flex gap-3 items-center pb-[16px] pt-[17px] px-3 w-full">
        <!-- Avatar circle -->
        <div 
        ...
        <svg 
          class="ml-auto shrink-0 w-[10px] h-[5px] text-zinc-400 cursor-pointer transition-transform duration-200"
