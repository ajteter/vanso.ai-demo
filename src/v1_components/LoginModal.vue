      ...
      >
        ...
        <Transition name="login-modal">
          <div class="bg-zinc-950 border border-white/10 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.6)] w-105 max-w-[90vw] p-10 flex flex-col items-center gap-[28px] relative">
            ...
            <!-- Close Button -->
            <button 
              class="absolute top-4 right-[16px] size-8 flex items-center justify-center rounded-full cursor-pointer transition-colors duration-200 hover:bg-white/5"
              @click="$emit('close')"
            >
            ...
            <button 
              class="flex items-center justify-center gap-3 w-full bg-white hover:bg-gray-100 rounded-full py-[14px] px-6 transition-colors duration-200 cursor-pointer shadow-[0_2px_8px_rgba(0,0,0,0.15)]"
