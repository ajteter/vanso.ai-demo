<script setup>
import { ref } from 'vue';
import Navbar from '../v1_components/Navbar.vue';
import Hero from '../v1_components/Hero.vue';
import LiveTicker from '../v1_components/LiveTicker.vue';
import Features from '../v1_components/Features.vue';
import Workflow from '../v1_components/Workflow.vue';
import Footer from '../v1_components/Footer.vue';
import LoginModal from '../v1_components/LoginModal.vue';
...
<template>
  <div class="bg-black flex flex-col items-start relative size-full overflow-x-hidden min-h-screen text-white font-['Plus_Jakarta_Sans',sans-serif]">
    ...
    <Hero @open-login="showLoginModal = true" />
    <LiveTicker />
    <Features />
    <Workflow />
    <Footer />
...
<style>
/* Staggered breathing animation for background glow spots */
...
.glow-orb-1 {
  animation: glowBreathe 8s ease-in-out 0s infinite;
}

.glow-orb-2 {
  animation: glowBreathe 8s ease-in-out 2s infinite;
}

.glow-orb-3 {
  animation: glowBreathe 8s ease-in-out 4s infinite;
}

.glow-orb-4 {
  animation: glowBreathe 8s ease-in-out 6s infinite;
}
</style>
