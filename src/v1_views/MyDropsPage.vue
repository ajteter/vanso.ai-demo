...
<template>
  <div class="flex flex-col gap-[32px] items-start max-w-[1280px] p-[40px] w-full">
    <!-- Header -->
    <div class="flex items-center justify-between w-full">
      <h1 class="font-bold text-[30px] text-white tracking-[-0.75px] leading-[36px] italic">My Drops</h1>
      <button 
        class="bg-gradient-to-br from-vanso-magenta via-vanso-peach to-vanso-cyan text-white font-semibold rounded-full px-[24px] py-[10px] shadow-[0_0_20px_rgba(245,50,138,0.3)] hover:shadow-[0_0_30px_rgba(84,227,213,0.5)] transition-shadow duration-300 flex items-center justify-center gap-[8px] cursor-pointer"
        @click="router.push({ name: 'NewDrop' })"
      >
        <svg class="shrink-0 size-[12px] text-white" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6 1V11M1 6H11" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
        </svg>
        <span class="font-bold text-[14px] text-white text-center leading-[20px]">New Drop</span>
      </button>
    </div>

    <!-- Drops Table -->
    <div class="bg-vanso-card border border-white/10 flex flex-col items-start overflow-hidden rounded-[16px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.5)] w-full">
      <!-- Table Header -->
      ...
      <div class="flex flex-col items-start w-full">
        ...
        >
          ...
          <!-- Metrics (plays + likes) -->
          <div class="w-[200px] px-[24px] py-[16px] flex items-center gap-[16px]">
    ...
    <Transition name="drawer">
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto">
          <div class="flex flex-col gap-[24px] items-start p-[32px]">
            <!-- Cover Art -->
            ...
            <div class="flex flex-col gap-[8px] w-full">
              ...
              <div class="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-[8px] overflow-hidden">
                <input 
                  ...
                  type="text" 
                  class="bg-transparent w-full px-[17px] py-[13px] text-[14px] text-white outline-none font-normal"
                />
              </div>
            </div>
            ...
            <div class="flex flex-col gap-[8px] w-full">
              ...
              <div class="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-[8px] overflow-hidden">
                <textarea 
                  ...
                  class="bg-transparent w-full px-[17px] py-[13px] text-[14px] text-white placeholder-[#a1a1aa] outline-none resize-none font-normal leading-[20px] min-h-[120px]"
                ></textarea>
              </div>
            </div>
          </div>
        ...
        <div class="backdrop-blur-[6px] bg-[rgba(0,0,0,0.2)] border-t border-[rgba(255,255,255,0.1)] shrink-0 w-full">
          <div class="flex gap-[16px] items-center justify-center py-[24px] px-[32px]">
            ...
            <button 
              class="rounded-full flex-[2] py-[12px] bg-gradient-to-br from-vanso-magenta via-vanso-peach to-vanso-cyan text-white shadow-[0px_0px_20px_0px_rgba(245,50,138,0.4)] hover:shadow-[0_0_30px_rgba(84,227,213,0.5)] transition-shadow duration-300 cursor-pointer"
            >
              <span class="font-bold text-[14px] text-center leading-[20px] block">Save Changes</span>
            </button>
          </div>
        </div>
      </div>
    ...
    <Transition name="overlay">
      ...
      >
        <Transition name="modal-pop">
          <div 
            v-if="showDeleteConfirm"
            class="bg-[#1a1a1a] border border-white/10 rounded-[20px] shadow-[0_25px_60px_rgba(0,0,0,0.6)] w-[400px] max-w-[90vw] p-[32px] flex flex-col items-center gap-[20px]"
          >
            <!-- Warning Icon -->
            <div class="size-[56px] rounded-full bg-[rgba(235,73,61,0.1)] flex items-center justify-center">
              <svg class="size-[28px] text-[#eb493d]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
