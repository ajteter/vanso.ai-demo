...
<template>
  <div class="flex flex-col gap-[32px] items-start max-w-[1280px] p-[40px] w-full">
    ...
    <div class="flex items-center justify-between w-full">
      ...
      <button 
        class="bg-gradient-to-br from-vanso-magenta via-vanso-peach to-vanso-cyan text-white font-semibold rounded-full px-[24px] py-[10px] shadow-[0_0_20px_rgba(245,50,138,0.3)] hover:shadow-[0_0_30px_rgba(84,227,213,0.5)] transition-shadow duration-300 flex items-center justify-center gap-[8px]"
    ...
    <!-- Stats Cards -->
    <div class="flex gap-[24px] items-start justify-center w-full">
      <!-- Total Plays Card -->
      <div class="bg-vanso-card border border-white/10 flex flex-1 flex-col items-start overflow-hidden p-[33px] rounded-[16px] h-[142px] relative">
        <!-- Background play icon watermark -->
        <div class="absolute bottom-[8px] right-[24px] opacity-[0.04]">
          <svg class="size-[100px] text-white" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex flex-col gap-[8px] items-start w-full relative z-[1]">
          ...
          <div class="flex gap-[12px] items-end w-full">
            ...
            <div class="bg-vanso-cyan/10 border border-vanso-cyan/20 flex items-center px-[9px] py-[5px] rounded-full">
              <svg class="shrink-0 w-[17px] h-[8px] text-[#54e3d5] mr-[2px]" viewBox="0 0 17 8" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="font-medium text-[14px] text-[#54e3d5] leading-[20px]">{{ stats[0].change }}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-vanso-card border border-white/10 flex flex-col items-start overflow-hidden rounded-[16px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.5)] w-full">
      ...
      <div class="border-b border-white/10 w-full">
        <div class="flex items-center justify-between py-[20px] px-[24px]">
          <h3 class="font-bold text-[18px] text-white tracking-[-0.45px] leading-[28px]">Recent Drops</h3>
          <button class="font-medium text-[14px] text-vanso-cyan text-center leading-[20px] cursor-pointer hover:underline" @click="router.push({ name: 'MyDrops' })">View All</button>
        </div>
      </div>
      ...
      <div class="flex flex-col items-start w-full">
        ...
        >
          ...
          <div class="w-[200px] px-[24px] py-[30px] text-right">
            <span class="font-medium text-[14px] text-white leading-[20px]">{{ drop.plays }}</span>
          </div>
          <!-- Status Badge -->
          <div class="w-[140px] px-[24px] py-[26px] flex items-center justify-center">
            <div 
              class="flex items-center justify-center px-[12px] py-[4px] rounded-full relative"
