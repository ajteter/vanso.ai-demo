...
<template>
  <div class="flex flex-col gap-8 items-start max-w-320 p-10 w-full">
      ...
      <div class="flex flex-col items-start w-full">
        ...
        >
          ...
          <div class="flex-1 px-6 py-4 flex items-center gap-4">
            <div 
              class="rounded-lg size-12 border border-white/10 shrink-0"
          ...
          <div class="w-30 px-6 py-4 flex items-center justify-center gap-3">
            <button 
              class="flex items-center justify-center rounded-[6px] size-8 cursor-pointer transition-colors duration-300 hover:bg-white/5"
            ...
            <button 
              class="flex items-center justify-center rounded-[6px] size-8 cursor-pointer transition-colors duration-300 hover:bg-[rgba(239,68,68,0.1)]"
    ...
    <div class="flex justify-center w-full">
      <button class="flex gap-2 items-center px-6 py-[10px] rounded-full bg-white/5 border border-white/10 cursor-pointer transition-colors duration-300 hover:bg-[rgba(255,255,255,0.08)]">
  ...
  <Teleport to="body">
    ...
    <Transition name="drawer">
      <div 
        ...
        class="fixed right-0 top-0 bottom-0 z-[101] backdrop-blur-xl bg-zinc-950 border-l border-white/10 flex flex-col w-125 max-w-[100vw]"
      >
        <!-- Header -->
        <div class="border-b border-white/10 w-full shrink-0">
          <div class="flex items-center justify-between py-6 px-8">
            ...
            <button 
              class="bg-white/5 border border-white/10 rounded-full size-9 flex items-center justify-center cursor-pointer transition-colors duration-300 hover:bg-white/10"
              @click="closeEditDrawer"
            >
        ...
        <div class="flex-1 overflow-y-auto">
          <div class="flex flex-col gap-6 items-start p-8">
            ...
            <div class="flex flex-col gap-3 items-center w-full">
              <div 
                class="rounded-xl w-50 h-50 border border-white/10 shadow-[0px_10px_30px_rgba(0,0,0,0.3)]"
            ...
            <div class="bg-white/5 border border-white/10 rounded-xl flex items-center gap-3 p-4 w-full">
            ...
            <div class="flex flex-col gap-2 w-full">
              ...
              <div class="relative bg-white/5 border border-white/10 rounded-lg overflow-hidden h-11">
        ...
        <Transition name="modal-pop">
          ...
          >
            ...
            <div class="flex gap-3 w-full mt-1">
              <button
                class="flex-1 border border-white/10 rounded-full py-3 cursor-pointer transition-colors duration-300 hover:bg-white/5"
                @click="cancelDelete"
              >
                <span class="font-medium text-sm text-white text-center leading-[20px] block">Cancel</span>
              </button>
              <button
                class="flex-1 bg-red-500 rounded-full py-3 cursor-pointer transition-all duration-300 hover:bg-red-600 shadow-[0_0_15px] shadow-red-500/30"
                @click="confirmDelete"
              >
